...
This guide demonstrates how to create a custom task using a CartPole example. You'll define the robot entity, configure the MDP, and train a policy.

Define the Robot
----------------

Define the robot model and entity configuration. This example uses a simple CartPole with a sliding base and a hinged pole.
