...
Ymboy_XML: Path = (
  MJLAB_SRC_PATH / "asset_zoo" / "robots" / "ymboy" / "xmls" / "ymboy_23dof.xml"
)
assert Ymboy_XML.exists()


def get_assets(meshdir: str) -> dict[str, bytes]:
  assets: dict[str, bytes] = {}
  update_assets(assets, Ymboy_XML.parent / "assets", meshdir)
  return assets


def get_spec() -> mujoco.MjSpec:
  spec = mujoco.MjSpec.from_file(str(Ymboy_XML))
...
Ymboy_ACTUATOR_5020 = BuiltinPositionActuatorCfg(
  joint_names_expr=(
    ".*_elbow_joint",
...
Ymboy_ACTUATOR_7520_14 = BuiltinPositionActuatorCfg(
...
Ymboy_ACTUATOR_7520_22 = BuiltinPositionActuatorCfg(
...
Ymboy_ACTUATOR_4010 = BuiltinPositionActuatorCfg(
...
Ymboy_ACTUATOR_WAIST = BuiltinPositionActuatorCfg(
...
Ymboy_ACTUATOR_ANKLE = BuiltinPositionActuatorCfg(
...
Ymboy_ARTICULATION = EntityArticulationInfoCfg(
  actuators=(
    Ymboy_ACTUATOR_5020,
    Ymboy_ACTUATOR_7520_14,
    Ymboy_ACTUATOR_7520_22,
    Ymboy_ACTUATOR_4010,
    # Ymboy_ACTUATOR_WAIST,
    Ymboy_ACTUATOR_ANKLE,
  ),
  soft_joint_pos_limit_factor=0.9,
)


def get_Ymboy_robot_cfg() -> EntityCfg:
  """Get a fresh Ymboy robot configuration instance.
  ...
  return EntityCfg(
    ...
    spec_fn=get_spec,
    articulation=Ymboy_ARTICULATION,
  )


Ymboy_ACTION_SCALE: dict[str, float] = {}
for a in Ymboy_ARTICULATION.actuators:
...
if __name__ == "__main__":
  ...
  robot = Entity(get_Ymboy_robot_cfg())
